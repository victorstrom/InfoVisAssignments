...
def create_network_graph(data, min_weight=1, highlight_node=None):
    ...
    # Node-link diagram layout using spring layout 
    ...
    # NODES (Details-on-demand and Brushing) 
    ...
    fig = go.Figure(data=[edge_trace, edge_hover_trace, node_trace],
                 layout=go.Layout(
                    showlegend=False,
                    hovermode='closest',
                    height=600, # Expanded height for large screens
...
app.layout = html.Div([
    ...
    html.Div([
        ...
        # Two diagram instances for comparison 
        html.Div([
